...
| **2. 비전 선언문** | "AI 자소서가 아니다. 개인의 대시보드 + Art of Creative" |
| **3. 5대 기능 도메인** | 커리어개발관리 / 업무자동화 / 배포&개발 / 미술창작 / 업무대리에이전트 |
| **4. 플랫폼 전략** | Web SPA(현재) → Mobile(Capacitor) → Desktop(Electron) → 브라우저확장 |
| **5. 기술 아키텍처** | Nuxt4 + Neon + Upstash + AI SDK v7 + Better Auth + PWA |
...
| **10. 단기 로드맵** | Sprint 1-4 구체적 체크리스트 |
