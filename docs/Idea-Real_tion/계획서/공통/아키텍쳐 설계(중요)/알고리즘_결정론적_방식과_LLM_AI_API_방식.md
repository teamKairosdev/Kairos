...
|------|:-----------:|:-------:|:---------:|:--------:|
| ATS 키워드 매칭 | ✅ 충분 | 오버스펙 | — | **알고리즘** |
| ATS 매칭 점수 계산 | ✅ 충분 | 오버스펙 | — | **알고리즘** |
| ATS 개선 제안 문장 | ❌ 불가 | ✅ 필요 | — | **LLM** |
| 이력서 고도화 (재작성) | ❌ 불가 | ✅ 필요 | — | **LLM** |
| 이력서 점수 (구조 평가) | ✅ 부분 | △ 보완 | ✅ | **하이브리드** |
| 면접 질문 생성 | ❌ 불가 | ✅ 필요 | — | **LLM** |
| 면접 답변 평가 | ❌ 불가 | ✅ 필요 | — | **LLM** |
| 면접 점수 계산 | ✅ 충분 | 오버스펙 | — | **알고리즘** |
| AI 문장 휴머나이저 | ❌ 불가 | ✅ 필요 | — | **LLM** |
| Q&A 플래시카드 생성 | ❌ 불가 | ✅ 필요 | — | **LLM** |
| 채용공고 자동 수집 | ✅ MCP/API | ❌ 불필요 | — | **알고리즘(MCP)** |
| 사용자 통계 집계 | ✅ 충분 | ❌ 불필요 | — | **알고리즘** |
| 스킬 갭 분석 (국가급) | ✅ 충분 | △ 보완 | ✅ | **하이브리드** |
| 커리어 추천 | △ 부분 | ✅ 필요 | ✅ | **하이브리드** |
