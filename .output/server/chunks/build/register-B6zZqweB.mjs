...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        _push(`<span>가입 중...</span>`);
      } else {
        _push(`<span>가입하기</span>`);
      }
      _push(`</button></form><div class="text-center text-xs text-gray-400 pt-2"> 이미 계정이 있으신가요? `);
...
//# sourceMappingURL=register-B6zZqweB.mjs.map
