import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, computed, toValue, reactive, getCurrentInstance, onServerPrefetch, defineComponent, shallowRef, h, resolveComponent, unref, ref, nextTick, toRef, defineAsyncComponent, createElementBlock, provide, cloneVNode, useSSRContext, createApp, shallowReactive, isVNode, createCommentVNode, withAsyncContext, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString, onErrorCaptured, resolveDynamicComponent, effectScope, Suspense, getCurrentScope, Fragment, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
import { q as hash, v as klona, w as parseQuery, x as defuFn, y as hasProtocol, z as joinURL, A as parseURL, k as encodePath, B as decodePath, C as isScriptProtocol, D as withQuery, e as createError$1, E as withTrailingSlash, F as withoutTrailingSlash, G as sanitizeStatusCode, $ as $fetch$1, H as baseURL, I as defu, J as createHooks, K as appendResponseHeader } from '../_/nitro.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { createSharedComposable } from '@vueuse/core';
import { extendTailwindMerge } from 'tailwind-merge';
import { _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DtGWg1eO.mjs')
  },
  {
    name: "qa",
    path: "/qa",
    component: () => import('./index-BJCSdS0Z.mjs')
  },
  {
    name: "ats",
    path: "/ats",
    component: () => import('./index-DDFjzDKH.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import('./login-CNaz7rTV.mjs')
  },
  {
    name: "resume-id",
    path: "/resume/:id()",
    component: () => import('./_id_-BVwqdbUi.mjs')
  },
  {
    name: "career",
    path: "/career",
    component: () => import('./index-COK69oVu.mjs')
  },
  {
    name: "resume",
    path: "/resume",
    component: () => import('./index-DLqdHudE.mjs')
  },
  {
    name: "auth-register",
    path: "/auth/register",
    component: () => import('./register-B6zZqweB.mjs')
  },
  {
    name: "interview-id",
    path: "/interview/:id()",
    component: () => import('./_id_-WpKBq8r5.mjs')
  },
  {
    name: "humanizer",
    path: "/humanizer",
    component: () => import('./index-BE8XKFwA.mjs')
  },
  {
    name: "interview",
    path: "/interview",
    component: () => import('./index-CbhH4RYr.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-m4l0vdAz.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "sticky top-0 z-50 glass-panel border-b border-white/10" }, _attrs))}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-10 h-10 rounded-xl bg-gradient-to-tr from-purple-600 via-indigo-500 to-cyan-400 p-[1px] shadow-lg group-hover:shadow-purple-500/50 transition-all duration-300"${_scopeId}><div class="w-full h-full bg-[#090d16] rounded-[11px] flex items-center justify-center font-bold text-lg text-purple-400"${_scopeId}> K </div></div><div${_scopeId}><span class="font-extrabold text-xl tracking-tight gradient-text"${_scopeId}>Kairos</span><span class="hidden sm:inline-block text-[10px] text-purple-300/70 ml-2 px-2 py-0.5 rounded-full border border-purple-500/20 bg-purple-500/10"${_scopeId}> AI Steward v1.0 </span></div>`);
          } else {
            return [
              createVNode("div", { class: "w-10 h-10 rounded-xl bg-gradient-to-tr from-purple-600 via-indigo-500 to-cyan-400 p-[1px] shadow-lg group-hover:shadow-purple-500/50 transition-all duration-300" }, [
                createVNode("div", { class: "w-full h-full bg-[#090d16] rounded-[11px] flex items-center justify-center font-bold text-lg text-purple-400" }, " K ")
              ]),
              createVNode("div", null, [
                createVNode("span", { class: "font-extrabold text-xl tracking-tight gradient-text" }, "Kairos"),
                createVNode("span", { class: "hidden sm:inline-block text-[10px] text-purple-300/70 ml-2 px-2 py-0.5 rounded-full border border-purple-500/20 bg-purple-500/10" }, " AI Steward v1.0 ")
              ])
            ];
          }
        }),
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span${_scopeId}>⚡ AI 모의 면접</span>`);
          } else {
            return [
              createVNode("span", null, "⚡ AI 모의 면접")
            ];
          }
        }),
        _: 1
      ...
      if (unref(user)) {
        _push(`<div class="flex items-center gap-3 border-l border-white/10 pl-4"><img${ssrRenderAttr("src", unref(user).avatarUrl)}${ssrRenderAttr("alt", unref(user).name)} class="w-8 h-8 rounded-full border border-purple-500/30 bg-purple-900/30"><span class="hidden md:inline text-sm font-medium text-gray-200">${ssrInterpolate(unref(user).name)}</span></div>`);
      } else {
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/auth/login",
...
const Navbar = Object.assign(_sfc_main$4, { __name: "Navbar" });
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<aside${ssrRenderAttrs(mergeProps({ class: "glass-panel rounded-2xl p-4 space-y-6" }, _attrs))}><div class="px-3 py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider"> 주요 서비스 메뉴 </div><nav class="space-y-1"><!--[-->`);
      ssrRenderList(navItems, (item) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          key: item.path,
          to: item.path,
          class: ["flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all group", unref(route).path === item.path ? "bg-purple-600/20 text-purple-300 border border-purple-500/30" : "text-gray-400 hover:text-gray-200 hover:bg-white/5"]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="text-lg group-hover:scale-110 transition-transform"${_scopeId}>${ssrInterpolate(item.icon)}</span><span${_scopeId}>${ssrInterpolate(item.label)}</span>`);
            } else {
              return [
                createVNode("span", { class: "text-lg group-hover:scale-110 transition-transform" }, toDisplayString(item.icon), 1),
      ...
      _push(`<!--]--></nav><div class="pt-4 border-t border-white/5"><div class="p-3.5 rounded-xl bg-purple-950/40 border border-purple-500/20 space-y-2"><div class="text-xs font-bold text-purple-300 flex items-center gap-1.5"><span>✨</span> Kairos LLM Engine </div><p class="text-[11px] text-purple-200/70 leading-relaxed"> OpenAI, Anthropic, Google Gemini 실시간 자동 Fallback 체인이 활성화되어 있습니다. </p></div></div></aside>`);
    };
  }
});
...
const Sidebar = Object.assign(_sfc_main$3, { __name: "Sidebar" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[#090d16] text-gray-100 flex flex-col relative selection:bg-purple-500 selection:text-white" }, _attrs))}><div class="fixed top-0 left-1/4 w-96 h-96 bg-purple-600/15 rounded-full blur-3xl pointer-events-none -z-10"></div><div class="fixed bottom-10 right-1/4 w-96 h-96 bg-cyan-600/15 rounded-full blur-3xl pointer-events-none -z-10"></div>`);
      _push(ssrRenderComponent(Navbar, null, null, _parent));
      _push(`<div class="flex-1 flex max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-12 gap-8">`);
      _push(ssrRenderComponent(Sidebar, { class: "hidden md:block w-64 shrink-0" }, null, _parent));
      _push(`<main class="flex-1 min-w-0">`);
      _push(ssrRenderComponent(_component_NuxtPage, null, null, _parent));
      _push(`</main></div><footer class="border-t border-white/5 py-6 text-center text-xs text-gray-500 glass-panel mt-auto"><p>© 2026 Kairos. &quot;당신의 시간에 의미를 부여하는 단 하나의 청지기 (Dispensator)&quot;</p></footer></div>`);
    };
  }
});
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DLiLbp8L.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BwA_bf2S.mjs'));
...
export { __nuxt_component_0 as _, useRouter as a, useRoute as b, useFetch as c, useAppConfig as d, entry_default as default, useNuxtApp as e, useRuntimeConfig as f, useAsyncData as g, useHead as u };
