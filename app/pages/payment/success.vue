<template>
  <div class="max-w-lg mx-auto p-6 text-center">
    <div v-if="verifying">
      <UIcon name="i-lucide-loader-2" class="w-12 h-12 mx-auto mb-4 animate-spin text-fg-brand" />
      <h1 class="text-xl font-bold">결제 확인 중...</h1>
    </div>

    <template v-else-if="error">
      <UIcon name="i-lucide-x-circle" class="w-16 h-16 text-fg-danger mx-auto mb-4" />
    ...
    <template v-else>
      <UIcon name="i-lucide-check-circle" class="w-16 h-16 text-fg-success mx-auto mb-4" />
